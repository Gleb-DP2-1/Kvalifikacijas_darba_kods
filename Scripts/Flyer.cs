...
public class Flyer : MonoBehaviour
{
    ...
    [System.NonSerialized] public RealEnemyBase enemyBase;
    ...
    void Start()
    {
        ...
        if (enemyBase.isBomb)
        {
            lookAtTarget =RealMovement.Instance.gameObject.transform;
        }
    ...
    void Update()
    {
        distanceFromPlayer.x = (RealMovement.Instance.transform.position.x + targetOffset.x) - transform.position.x;
        distanceFromPlayer.y = (RealMovement.Instance.transform.position.y + targetOffset.y) - transform.position.y;
        ...
        {
            speed = Vector2.zero;
            if (transform.position.y > (RealMovement.Instance.transform.position.y + targetOffset.y) && sawPlayer)
            {
